...
class ClassAutoLoader extends Zend_Loader_Autoloader {
    ...
    public static $arrClasses = array(
        ...
        'WebControllerAction'           => '/library/massiveart/controllers/web.controller.action.class.php',
        'TidyControllerPlugin'          => '/library/massiveart/controllers/plugins/tidy.controller.plugin.class.php',
        'ModelAbstract'                 => '/library/massiveart/models/abstract.class.php',
        ...
        'StatisticsCommandChain'        => '/library/massiveart/command/newsletter/statistics.command.chain.class.php',
        ...
        'NewsletterStatisticsCommand'   => '/library/massiveart/command/newsletter/statistics.command.class.php',
        'NewsletterStatisticsInterface' => '/library/massiveart/newsletter/newsletter.statistics.interface.php',
