...
<head>
    ...
    <?php if(Zend_Auth::getInstance()->setStorage(new Zend_Auth_Storage_Session())->hasIdentity()) : ?>
        <link rel="stylesheet" type="text/css" media="screen" href="<?php get_static_component_domain() ?>/website/themes/default/css/modus.css"/>
        <script type="text/javascript" src="<?php get_static_component_domain() ?>/website/themes/default/js/modus.js"></script>
    <?php endif; ?>

    <link rel="shortcut icon" href="<?php get_static_component_domain() ?>/favicon.ico" type="image/x-icon"/>
