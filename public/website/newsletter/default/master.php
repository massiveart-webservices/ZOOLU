...
<head>
	...
	<title><?php echo $objHelper->getTitle('', false) ?></title>
	<style type="text/css">
  ...
  /** BONUS: Adaptation of Brian Thies (Campaign Monitor) link color fix to render the Yahoo Short Cuts invisible. **/
...
<body>
    ...
    <!-- Template Content -->
    <?php include dirname(__FILE__).'/templates/'.$this->template_file ?>
