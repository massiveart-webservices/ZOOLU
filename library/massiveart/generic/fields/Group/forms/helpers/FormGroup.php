...
class Form_Helper_FormGroup extends Zend_View_Helper_FormElement
{
     ...
     * @version 1.0
     */
    public function formGroup($name, $value = null, $attribs = null)
    {
        ...
        $strOutput = '<div class="conwrapper">
                    <div class="contop">' . $core->translate->_('Add_groups') . ': <img src="/zoolu-statics/images/icons/icon_addmedia.png" width="16" height="16" onclick="myForm.getAddGroupOverlay(\'divContactContainer_' . $this->view->escape($id) . '\', \'' . $this->view->escape($id) . '\'); return false;"/></div>
