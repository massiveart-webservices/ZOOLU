...
INSERT INTO `fieldTypes` (`id`, `idDecorator`, `sqlType`, `size`, `title`, `defaultValue`, `idFieldTypeGroup`) VALUES ('36', '1', '', '0', 'seo', '', '5');

-- update seo_description, seo_keywords, seo_title, seo_canonical fields types to `seo`
UPDATE `fields` SET `idFieldTypes` = '36' WHERE `name` = 'seo_description';
UPDATE `fields` SET `idFieldTypes` = '36' WHERE `name` = 'seo_keywords';
UPDATE `fields` SET `idFieldTypes` = '36' WHERE `name` = 'seo_title';
