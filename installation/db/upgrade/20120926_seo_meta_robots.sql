...
-- Categories
INSERT INTO `categories` (`id`, `idParentCategory`, `idRootCategory`, `idCategoryTypes`, `matchCode`, `lft`, `rgt`, `depth`) VALUES (NULL, '0', '666', '2', NULL, '1', '4', '0');
...
-- Child Categories
INSERT INTO `categories` (`id`, `idParentCategory`, `idRootCategory`, `idCategoryTypes`, `matchCode`, `lft`, `rgt`, `depth`) VALUES (NULL, '0', '669', '2', NULL, '1', '4', '0');
...
-- Category titles
INSERT INTO `categoryTitles` (`id`, `idCategories`, `idLanguages`, `title`, `idUsers`, `changed`) VALUES (NULL, '667', '1', 'noindex', '2', CURRENT_TIMESTAMP);
INSERT INTO `categoryTitles` (`id`, `idCategories`, `idLanguages`, `title`, `idUsers`, `changed`) VALUES (NULL, '670', '1', 'nofollow', '2', CURRENT_TIMESTAMP);
