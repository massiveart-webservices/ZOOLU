 ...
 */
function getSubscriberHelperObject()
{
    return Zend_Registry::get('SubscriberHelper');
}
...
function get_meta_title($strTag = '') {
    echo getSubscriberHelperObject()->getMetaTitle($strTag);
}
...
function get_content($objView) {
    echo getSubscriberHelperObject()->getContent($objView);
}
