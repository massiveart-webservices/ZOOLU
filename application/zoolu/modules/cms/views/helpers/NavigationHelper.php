      ...
      <div class="portalcontainer">
        ...
        foreach($objNavigationTree as $objNavigation){
          if(Security::get()->isAllowed(Security::RESOURCE_ROOT_LEVEL_PREFIX.$objNavigation->getId(), Security::PRIVILEGE_VIEW)){                        
            ...
            $strOutput .= '
                <a href="#" onclick="myNavigation.selectRootLevel('.$objNavigation->getItemId().','.$objNavigationTree->getItemId().$strUrlAddon.'); return false;">'.(($objNavigation->getTypeId() == $this->core->sysConfig->root_level_types->shops) ?  $this->core->translate->_('Shop') : $this->core->translate->_('Web_content')).'</a>';
            if($objNavigation->getTypeId() == $this->core->sysConfig->root_level_types->shops){ 
              $strSpanAddon = '';
