...
class Users_GroupController extends AuthControllerAction
{
                ...
                if (isset($arrFormData['Region_Permission_Instances'])) {
                    ...
                    foreach ($arrRegionInstanceIds as $intRegionInstanceId) {
                        if (isset($arrFormData['language_' . $intRegionInstanceId]) && isset($arrFormData['permissions_' . $intRegionInstanceId])) {
                            $this->arrPermissions[$intRegionInstanceId] = array(
                                'language'    => $arrFormData['language_' . $intRegionInstanceId],
    ...
    protected function initForm()
    {
        ...
        $this->objForm->addElement('multiCheckbox', 'groupTypes', array(
                                                                       'label'        => $this->core->translate->_('groupTypes', false),
        ...
        foreach ($this->arrPermissions as $arrPermission) {
            $intRegionCounter++;
            $this->objForm->addElement('radio', 'language_' . $intRegionCounter, array(
                                                                                      'label'        => $this->core->translate->_('language', false),
            ...
            $this->objForm->addElement('multiCheckbox', 'permissions_' . $intRegionCounter, array(
                                                                                                 'label'        => $this->core->translate->_('permissions', false),
