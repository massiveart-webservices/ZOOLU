...
class Users_UserController extends Zend_Controller_Action {
  ...
  protected function initForm($blnSingleEdit = false){
    ...
    $this->objForm->addElement('text', 'email', array('label' => $this->core->translate->_('email', false), 'decorators' => array('Input'), 'columns' => 12, 'class' => 'text', 'required' => true));
    ...
    $this->objForm->addDisplayGroup(array('fname', 'sname', 'username', 'language', 'email', 'idFiles'), 'main-group');
